...
export const EditProfile = ({ route, navigation }) => {
  ...
  const [options, setOptions] = useState({
    ...
    actorRelation: auth?.results?.actorRelation,
  });
  ...
  const getAllOptionsData = async () => {
    ...
    if (res?.status == 200) {
      setOptions({
        ...
        actorRelation: res?.results?.group_63181d08b7031,
      });
    }
  };
    ...
    if (res.status == 200) {
      ...
      setBasicDetails({
        ...
        birthDate: post_meta_details?.dob
          ? new Date(post_meta_details?.dob)
          : new Date(),
        age: res?.results?.extra?.age_months
          ? res?.results?.extra?.age_months
          : post_meta_details?.age,
        model_age: post_meta_details?.age,
        displayName: userData?.display_name,
        hourlyRate: post_meta_details?.perhour_rate,
      ...
      setRelationStatus(userData?.relationship_status || "");
      setLanguage(post_meta_details?.languages);
      ...
      setCallingCode(userData?.country_code || "1");
      setAuditions({
      ...
      if (
        ...
        if (measurment) {
          ...
          setDressSize(measurment?.dress_size);
          setPantSize(
          ...
          // setShirtSizeFC(measurment?.shirt_size);
          // setPantSizeWC(measurment?.pant_size_waist);
          // setPantSizeLC(measurment?.pant_size_length);
          // // setDressSizeC(measurment?.dress_size);
          // setBraCupC(measurment?.bra_cup);
          // setBraSizeC(measurment?.bra_size);
          // setShoeSizeC(measurment?.shoe_size);
          // setPantSize(measurment?.pant_size);
        }
      }
  ...
  const handleProfileSetup = async () => {
    ...
    console.log("obobfvfbvjokjb-------", body);
    ...
    >
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ ...Styles?.container }}>
          ...
          >
            <TextComponent text="Your Basic" size={Sizes?.s} fontWeight="400" />
          </View>
          {userRole != 12 && (
            <DropDownList
              placeholder={
            ...
            <>
              ...
              {talent == "Kid" || talent == "child" ? (
                <InputBox
                  ...
                  isEmpty={error && isFieldEmpty(basicDetails?.guardianName)}
                />
              ) : null}
              <DropDownList
          ...
          <InputBox
            ...
            editable={userData?.user_data?.phone_verified_status ? false : true}
            // fontIcon={"phone-dial"}
          />
          <InputBox
            type="text"
          ...
          {talent == "Actor" ? (
            <DropDownList
              ...
              options={
                options?.actorRelation?.relationship_status?.field_meta?.choices
              }
          ...
          {userRole == 12 ? (
            <>
              ...
              <InputBox
                ...
                isEmpty={error && isFieldEmpty(clientDetails?.businessEmail)}
              />
              <InputBox
                type="text"
                ...
                isEmpty={error && isFieldEmpty(clientDetails?.businessWebsite)}
              />
              <InputBox
                type="text"
        ...
        <View style={{ ...Styles?.container }}>
          {userRole != 12 && (
            <>
              ...
              >
                <TextComponent
                  text={userRole == 11 ? "Bio Details" : "Bio & Experiences"}
                  size={Sizes?.s}
                  fontWeight="400"
                />
              </View>
            ...
            <>
              {userRole == 11 || userRole == 15 ? (
                <>
                  ...
                  >
                    <TextComponent
                      text={userRole == 11 ? "Model Details" : "Actor Details"}
                      size={Sizes?.s}
                      fontWeight="400"
                    />
                  </View>
                    ...
                    <TextComponent
                      text={
                        talent == "child" && basicDetails?.model_age <= 2
                          ...
                          : `${userRole == 11 ? "Model" : "Actor"} Measurement`
                      }
                      size={Sizes?.s}
                      fontWeight="400"
                    />
                    ...
                    gender == "Male" || gender == "male" ? (
                      <>
                        <InputBox
                          ...
                          border={false}
                          isEmpty={error && isFieldEmpty(shirtSizeC?.length)}
                        />
                        <InputBox
                          type="multiselect"
                          ...
                          border={false}
                          isEmpty={error && isFieldEmpty(pantSizeWC?.length)}
                        />
                        <InputBox
                          type="multiselect"
              ...
              {userRole == "11" || userRole == 11 ? (
                <>
                  ...
                  >
                    <TextComponent
                      text={
                        talent == "child" && basicDetails?.age <= 2
                  ...
                  {talent == "Kid" || talent == "child" ? (
                    gender == "Male" || gender == "male" ? (
                      <>
                        ...
                        <InputBox
                          ...
                          icon={Images?.pantIcon}
                          value={pantSizeLC}
                          setOption={setPantSizeLC}
                          options={
                            options?.maleOptions?.pant_size_length?.field_meta
                              ?.choices
                          }
                          border={false}
                          isEmpty={error && isFieldEmpty(pantSizeLC?.length)}
                        />
                      ...
                      <>
                        <InputBox
                          ...
                          fontIcon={"tshirt-crew"}
                          value={shirtSizeFC}
                          setOption={setShirtSizeFC}
                          options={
                            options?.femaleOptions?.shirt_size_f?.field_meta
                              ?.choices
                          }
                          border={false}
                          isEmpty={error && isFieldEmpty(shirtSizeFC?.length)}
                        />
                        ...
                        <InputBox
                          ...
                          border={false}
                          isEmpty={error && isFieldEmpty(pantSize)?.length}
                        />
                        ...
                        <InputBox
                          ...
                          border={false}
                          isEmpty={error && isFieldEmpty(dressSizeC?.length)}
                        />
                    ...
                    <>
                      <InputBox
                        ...
                        border={false}
                        isEmpty={error && isFieldEmpty(shirtSize?.length)}
                      />
                      ...
                      <InputBox
                        ...
                        border={false}
                        isEmpty={error && isFieldEmpty(shoeSize?.length)}
                      />
                      {/* basicDetails?.age >= 2 ||
                    (basicDetails?.age >= 2 && basicDetails?.age >= 5) ||
                    (basicDetails?.age >= 5 &&   
                      {basicDetails?.age > 13 && (
                        <>
                          <DropDownList
                            ...
                            border={false}
                            isEmpty={error && isFieldEmpty(dressShirt)}
                          />
                          ...
                          <DropDownList
                            ...
                            border={false}
                            isEmpty={error && isFieldEmpty(shirtSleeve)}
                          />
                          <DropDownList
                            placeholder={"Neck Size *"}
                            icon={Images?.shirtNeck}
                            ...
                            border={false}
                            isEmpty={error && isFieldEmpty(neckSize)}
                          />
                          ...
                          <DropDownList
                            ...
                            border={false}
                            isEmpty={error && isFieldEmpty(chestSize)}
                          />
                          ...
                          <DropDownList
                            ...
                            border={false}
                            isEmpty={error && isFieldEmpty(jacket)}
                          />
                        </>
                      )}
                    </>
